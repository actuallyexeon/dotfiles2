...
beautiful.init("/home/exeon/.config/awesome/theme.lua")
...
naughty.config.defaults['font'] = "sans 13"
naughty.config.defaults['margin'] = 10
-- naughty.config.defaults['width'] = 200
naughty.config.defaults['border_width'] = 7
naughty.config.defaults['border_color'] = "#606060"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
	    ...
	    awful.widget.watch('curl -s "wttr.in/Osaka,JP?format=1" | sed "s/   / /"', 60),
	    --wibox.widget.textbox("   "),
	    --awful.widget.watch('bash /home/exeon/.local/bin/cpu', 2),
	    wibox.widget.textbox("  "),
            s.mylayoutbox,
        },
    }
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,		  }, "h", function () countdown.set() end,
    	      {description = "use timer", group = "awesome"}),
    awful.key({ modkey, "Control"   }, "h", function () countdown.reset() end,
              {description = "use timer", group = "awesome"}),
    ...
    awful.key({ modkey, "Shift"   }, "e",     function () awful.tag.incnmaster( 1, nil, true) end,
